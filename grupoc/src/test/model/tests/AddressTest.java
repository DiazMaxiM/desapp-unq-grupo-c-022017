...
public class AddressTest {
	...
	public void testShouldFailWhenICreateAnInvalidAddressWithInvalidMapPosition()throws InvalidAddressException, InvalidMapPositionException {
	...
	@Test(expected=InvalidAddressException.class)
	public void testShouldFailWhenICreateAnInvalidAddressWithInvalidLocality()throws InvalidAddressException, InvalidMapPositionException {
		MapPosition mapPosition= new MapPosition(new Double(114), new Double(12));
		new Address(null,"monserrat","558","12",mapPosition);
	}
	
	@Test(expected=InvalidAddressException.class)
	public void testShouldFailWhenICreateAnInvalidAddressWithInvalidStreet()throws InvalidAddressException, InvalidMapPositionException {
		MapPosition mapPosition= new MapPosition(new Double(114), new Double(12));
		new Address(Locality.ALMIRANTEBROWN,"","558","12",mapPosition);
	}
	
	@Test(expected=InvalidAddressException.class)
	public void testShouldFailWhenICreateAnInvalidAddressWithInvalidStreetNumber()throws InvalidAddressException, InvalidMapPositionException {
		MapPosition mapPosition= new MapPosition(new Double(114), new Double(12));

...
public class SalesAdministration {
	...
	public void saleMenu(Order order, Client client, Provider provider)
			throws PendingScoreException, BalanceInsufficient, InvalidPurchaseException, EmailException {
	...
	private void manageSales(Order order, Client client, Provider provider)
			throws BalanceInsufficient, InvalidPurchaseException, EmailException {
	...
	private void forSale(Order order, Client client, Provider provider)
			throws InvalidPurchaseException, BalanceInsufficient, EmailException {
	...
	private void finishSale(Order order, Client client, Provider provider)
			throws BalanceInsufficient, InvalidPurchaseException, EmailException {
	...
	private Transaction payTheProvider(Order order, Provider provider) throws BalanceInsufficient, EmailException {
		...
		this.mail.send(provider.getEmail(), "Pedido Pendiente",
				"Se realizo una compra por " + priceToAcredit.toString());

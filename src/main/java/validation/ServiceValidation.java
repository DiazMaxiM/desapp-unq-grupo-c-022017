...
public class ServiceValidation extends Validation {
	...
	public boolean isAValidService(String serviceName, String serviceLogo, Address serviceAddress,
			String serviceDescription, String serviceWebDirection, String serviceEmail, Telephone serviceTelephone,
			List<WorkingTime> serviceWorkingHours) throws InvalidServiceNameException, InvalidAddressException,
	...
	private boolean isValidServiceWorkingHours(List<WorkingTime> serviceWorkingHours)
			throws InvalidServiceWorkingHoursException {

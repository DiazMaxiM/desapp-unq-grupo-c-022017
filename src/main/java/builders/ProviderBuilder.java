...
public class ProviderBuilder {
	...
	public ProviderBuilder() throws InvalidLocalNumberException, InvalidAreaCodeException, InvalidCountryCodeException,
	...
	public Provider build() throws InvalidAddressException, InvalidTelephoneNumberException, InvalidCuitException,
			InvalidFirstNameException, InvalidLastNameException, InvalidEmailAddressException,
			InvalidMapPositionException {
		return new Provider(userCuit, userfirstName, userLastName, userEmailAddress, userTelephone, userAddress, null);
	}
